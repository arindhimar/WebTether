...
export default function SettingsPage() {
  ...
  return (
    <motion.div
      className={`container max-w-4xl py-6 space-y-8 ${mounted ? "animate-fade-in" : "opacity-0"}`}
      initial="hidden"
      animate="visible"
          ...
          <TabsContent value="profile" className="animate-card-appear">
            <AnimatedCard>
              <form onSubmit={handleProfileSubmit}>
                ...
                <CardFooter>
                  <Button type="submit" variant="gradient" className="animate-in-button shadow-glow">
                    Save Changes
                  </Button>
                </CardFooter>
              </form>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setNotifications({ ...notifications, validatorActivity: checked })
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
