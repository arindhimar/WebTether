...
export function ReplitAgentSetup({ onComplete, onSkip }) {
    ...
    const REPLIT_TEMPLATE_URL = "https://replit.com/@arindhimarfc/Replit-Ping-Agent"
    const EXAMPLE_TOKEN = "superSecretArinToken"
                ...
                <div className="flex items-center justify-center mb-8">
                    {steps.map((step, index) => (
                        <div key={index} className="flex items-center">
                            <div
                                className={`flex items-center justify-center w-10 h-10 rounded-full border-2 ${currentStep > index + 1
                                ...
                                <div className="bg-muted/50 p-6 rounded-lg">
                                    ...
                                    <ol className="space-y-3 text-sm">
                                        ...
                                        <li className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="font-medium">Fork/Remix the project to your account</p>
                                                <p className="text-muted-foreground">Click "Fork/Remix" to create your own copy</p>
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <Badge variant="outline" className="mt-0.5">
                                        ...
                                        <li className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-2 p-3 bg-black text-green-400 rounded font-mono text-xs relative">
                                                    <code>AUTH_TOKEN={EXAMPLE_TOKEN}</code>
                                                    <Button
                                                        variant="ghost"
                                                        size="sm"
                                                        className="absolute top-1 right-1 h-6 w-6 p-0 text-green-400 hover:text-green-300"
                                                        onClick={() => handleCopyToClipboard(`AUTH_TOKEN=${EXAMPLE_TOKEN}`)}
                                                    >
                                ...
                                <form onSubmit={handleAgentSubmit} className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            disabled={isLoading}
                                        />
                                        <p className="text-xs text-muted-foreground">The AUTH_TOKEN value from your .env file</p>
                                    </div>
